...
* [2026] ESPIRE: A Diagnostic Benchmark for Embodied Spatial Reasoning of Vision-Language Models [[paper](https://arxiv.org/pdf/2603.13033)]
...
* [2026] Learning Situated Awareness in the Real World [[paper](https://arxiv.org/pdf/2602.16682)] [[project](https://sawbench.github.io/)]
* [2025] VLNVerse: A Benchmark for Vision-Language Navigation with Versatile, Embodied, Realistic Simulation and Evaluation [[paper](https://arxiv.org/pdf/2512.19021)]
...
* [2025] NavBench: Probing Multimodal Large Language Models for Embodied Navigation [[paper](https://arxiv.org/pdf/2506.01031)]
...
* [2025] EmbodiedEval: Evaluate Multimodal LLMs as Embodied Agents [[paper](https://arxiv.org/pdf/2501.11858)] [[code](https://github.com/thunlp/EmbodiedEval)]
...
* [2024] ReALFRED: An Embodied Instruction Following Benchmark in Photo-Realistic Environments [[paper](https://arxiv.org/pdf/2407.18550)]
...
* [2024] BEHAVIOR-1K: A Human-Centered, Embodied AI Benchmark with 1,000 Everyday Activities and Realistic Simulation [[paper](https://arxiv.org/pdf/2403.09227)] [[project](https://behavior.stanford.edu/)]
...
* [2022] TEACh: Task-driven Embodied Agents that Chat [[paper](https://arxiv.org/pdf/2110.00534)] [[project](https://teachingalfred.github.io/)]
* [2021] BEHAVIOR: Benchmark for Everyday Household Activities in Virtual, Interactive, and Ecological Environments [[paper](https://arxiv.org/pdf/2108.03332)] [[project](https://behavior.stanford.edu/)]
* [2021] SOON: Scenario Oriented Object Navigation with Graph-based Exploration [[paper](https://arxiv.org/pdf/2103.17138)] [[code](https://github.com/zhufengdaaa/soonofficialpytorch)]
...
* [2020] ALFRED: A Benchmark for Interpreting Grounded Instructions for Everyday Tasks [[paper](https://arxiv.org/pdf/1912.01734)] [[project](https://askforalfred.com/)]
...
* [2026] RynnBrain: Open Embodied Foundation Models [[paper](https://arxiv.org/pdf/2602.14979)] [[project](https://huggingface.co/papers/2602.14979)]
...
* [2018] Embodied Question Answering [[paper](https://arxiv.org/pdf/1711.11543)] [[project](https://embodiedqa.org/)]
